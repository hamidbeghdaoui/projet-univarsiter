...
class Ajouter_E extends Component {
    // ----------------------------------------- data----------------------------------------
    state = {
        compenet: "spinner",
        formModale: 'ajouter',
    ...
    getCherEtudiant = (mote) => {
        ...
        axios({
            ...
            headers: { 'content-type': 'application/json' },
            data: {
                but: 'get-cher-etudiant-for-admin',
                moteDeCHer: mote
            }
        })
            .then(result => {
                ...
                <div className="w-100 my-5">
                    ...
                    <div className="col-12 mt-3">
                        <div className="input-group mb-2">
                            <input type="text" className="form-control" placeholder="Rechercher un (nom)etudiant"
                            ...
                            this.state.listEtudiant != null && this.state.listEtudiant.length != 0 ?
                                <Fragment>
                                    {this.state.spinnerCher === true ? <Spinner />
                                        : this.FunComponentListeEtudiant()}
                                </Fragment>
                                :
                                <Fragment>
                        ...
                        <div className="modal-dialog">
                            <div className="modal-content">
                                <div className="modal-header">
                                    <h5 className="modal-title" id="exampleModalLabel">Ajouter un Etudint </h5>
                                ...
                                <div className="modal-footer">
                                    ...
                                    <button type="button" className="btn btn-primary" onClick={() => this.AddEtudiant()}>Ajouter</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="modal fade exampleModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div className="modal-dialog">
                            <div className="modal-content">
                                ...
                                <div className="modal-footer">
                                    <button type="button" className="btn btn-secondary" data-dismiss="modal">Annuler</button>
                                    <button type="button" className="btn btn-success" onClick={() => this.modiferInfoEtudiant()}>Mdifier</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    itemListEtudiant = () => {
        const Resalt = this.state.listEtudiant.map(item => {
            return (
                <tr data-toggle="modal" data-target=".exampleModal" key={item.id}
                    onClick={() => this.getInfoEtudiantInItemList(item.id)}>
